printf("Règles classiques de Sokoban :\n
Le joueur doit placer toutes les caisses (%c) sur toutes les cibles (%c)\n
Mais attention !\n
Un joueur est trop faible pour pousser 2 caisses à la fois ...\n
Ou même les tirer !\n
\n
