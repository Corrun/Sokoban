...
typedef struct
{
	...
	int colonnes; // Nombre de colonnes du niveay=u (largeur en cases)
...
// Détermine pour le niveau spéfcifié l'indice du tableau terrain correspondant aux coordonnéres spécifiées
